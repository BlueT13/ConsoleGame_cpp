...
int main()
{
	...
	FightZone BeginnerFightZone(1);
	FightZone IntermediateFightZone(2);
	FightZone AdvancedFightZone(3);
	...
	while (true)
	{
		...
		case '1':
			...
			break;
		case '2':
			BeginnerFightZone.In(NewPlayer, 1);
			break;
		case '3':
			IntermediateFightZone.In(NewPlayer, 2);
			break;
		case '4':
			AdvancedFightZone.In(NewPlayer, 3);
			break;
		default:
			break;
		}
